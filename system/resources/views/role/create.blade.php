                ...
                <div class="tab-content">
                  ...
                  <div id="tabe-3" class="container tab-pane fade">
                    <table class="table table-hover table-striped">
                            ...
                            <tr>
                                ...
                                <td style="text-align:center;"><input type="checkbox" name="selectedRoles[]" value="{{$group->where('name','Dispensasi-View')->first()->access_id}}"></td>
                                <td style="text-align:center;"><input type="checkbox" name="selectedRoles[]" value="{{$group->where('name','Dispensasi-Add')->first()->access_id}}"></td>
                                <td style="text-align:center;"><input type="checkbox" name="selectedRoles[]" value="{{$group->where('name','Dispensasi-Edit')->first()->access_id}}"></td>
                                <td style="text-align:center;"><input type="checkbox" name="selectedRoles[]" value="{{$group->where('name','Dispensasi-Delete')->first()->access_id}}"></td>
                            </tr>
                        </tbody>
                    </table>
                  </div>
                  ...
                  <table class="table table-hover table-striped">
                            ...
                            <tr>
                                ...
                                <td style="text-align:center;"><input type="checkbox" name="selectedRoles[]" value="{{$group->where('name','LaporanHarian-View')->first()->access_id}}"></td>
                                <td style="text-align:center;"></td>
                                <td style="text-align:center;"></td>
                                <td style="text-align:center;"></td>
                            </tr>
                            <tr>
                                ...
                                <td style="text-align:center;"><input type="checkbox" name="selectedRoles[]" value="{{$group->where('name','LaporanBulanan-View')->first()->access_id}}"></td>
                                <td style="text-align:center;"></td>
                                <td style="text-align:center;"></td>
                                <td style="text-align:center;"></td>
                            </tr>
                            <tr>
                                ...
                                <td style="text-align:center;"><input type="checkbox" name="selectedRoles[]" value="{{$group->where('name','LaporanTahunan-View')->first()->access_id}}"></td>
                                <td style="text-align:center;"></td>
                                <td style="text-align:center;"></td>
                                <td style="text-align:center;"></td>
                            </tr>
                            <tr>
                                ...
                                <td style="text-align:center;"><input type="checkbox" name="selectedRoles[]" value="{{$group->where('name','ResumePenyewa-View')->first()->access_id}}"></td>
                                <td style="text-align:center;"></td>
                                <td style="text-align:center;"></td>
                                <td style="text-align:center;"></td>
                            </tr>
                            <tr>
                                ...
                                <td style="text-align:center;"><input type="checkbox" name="selectedRoles[]" value="{{$group->where('name','DaftarPenyewa-View')->first()->access_id}}"></td>
                                <td style="text-align:center;"></td>
                                <td style="text-align:center;"></td>
                                <td style="text-align:center;"></td>
                            </tr>
